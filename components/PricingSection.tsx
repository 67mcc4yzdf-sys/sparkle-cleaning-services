        ...
        <Reveal delay={.08} className="relative">
          ...
          <div className="rounded-[2rem] border border-pink-200 bg-white/90 p-6 shadow-2xl shadow-pink-200/60 sm:p-9">
            <div className="mb-7 text-center">
              <p className="inline-flex items-center gap-2 rounded-full bg-pink-100 px-4 py-2 text-xs font-extrabold uppercase tracking-[.15em] text-[var(--primary)]">Pricing <Heart size={14} /></p>
              <p className="mt-3 text-sm font-bold text-slate-500">Prices start from:</p>
            </div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <a href={`tel:${business.phoneHref}`} className="button-secondary flex-1">Call {business.phone}</a>
            </div>
          </div>
        </Reveal>
      </div>
