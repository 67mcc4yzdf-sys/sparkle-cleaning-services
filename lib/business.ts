...
export const business = validateBusinessConfig({
  ...
  hero: {
    ...
    title: "Your Home, Freshened With a Celestial Glow",
    lead: "Friendly local cleaning services in Baldivis, WA, helping busy homes feel fresh, calm, and beautifully cared for.",
    supportingText: "Professional cleaning that leaves your home spotless, fresh, and glowing with a warm personal touch.",
    reassurance: "Friendly, reliable and detail-focused.",
  },
  about: {
    heroTitle: "Life gets busy. Your home can still feel beautifully cared for.",
    ...
    story: "Keeping your home fresh can feel impossible when life gets busy. Celestial Glow Cleaning Co. helps take the pressure off with reliable cleaning that makes your space feel lighter, calmer, and easier to enjoy.",
    mission: "The goal is simple: homes left spotless, fresh and glowing, with an enquiry process that feels easy from the first message.",
    ownerHeading: "A personal, friendly cleaning brand",
    ownerText: "Warm, approachable and detail-focused, Celestial Glow brings a soft personal touch to every clean without feeling cold or corporate.",
  },
  servicesPage: {
  ...
  whyChooseUs: {
    ...
    title: "Trust-building cleaning with a soft personal touch.",
    description: "A local Baldivis service that feels friendly, approachable and polished, with detail-focused cleaning that helps your home feel calm again.",
    differentiator: "From everyday resets to specific room requests, the process is simple: send what you need, get availability, and let the glow return.",
  ...
  servicePromise: {
    ...
    text: "Share your location, preferred day and what needs attention. Celestial Glow will reply with availability and next steps.",
  },
  pricing: {
    heading: "Ready for your home to glow?",
    explanation: "Send a quick enquiry with what you need cleaned, your location, and your preferred day. Celestial Glow Cleaning Co. will get back to you with availability and details.",
    recurringNote: "Message first. Book with confidence.",
    items: [
      { label: "Tell us what you need", price: "Room, tasks or clean type" },
      { label: "Share your suburb", price: "Baldivis or nearby" },
      { label: "Pick a preferred day", price: "We confirm availability" },
      { label: "Relax into the glow", price: "Fresh, calm, cared-for home" },
    ],
    footer: "Simple, friendly and made for Instagram enquiries.",
  },
  ...
  services: [
    { title: "Regular Home Cleaning", description: "For keeping your home feeling calm, fresh and cared for week after week.", icon: "home", bestFor: "Busy households wanting reliable upkeep", planningNote: "Choose the routine and rooms that matter most.", pricingNote: "Easy recurring enquiries", recurringAvailable: true, included: ["Dusting and surfaces", "Floors", "Kitchen reset", "Bathroom refresh"] },
    { title: "Deep Cleaning", description: "A more detailed reset for build-up, hard-to-reach places and homes that need extra glow.", icon: "sparkles", bestFor: "Seasonal resets and first-time cleans", planningNote: "Allow extra time for detail-focused work.", pricingNote: "Quoted by home and scope", recurringAvailable: false, included: ["Detail surfaces", "Edges and touchpoints", "Kitchen and bathroom focus", "Floor care"] },
    { title: "Kitchen Cleaning", description: "A satisfying kitchen refresh so benches, sinks and high-use areas feel bright again.", icon: "sparkles", bestFor: "High-use kitchens needing attention", planningNote: "Mention appliances or cupboards in your enquiry.", pricingNote: "Add to any clean", recurringAvailable: true, included: ["Benches and splashbacks", "Sink shine", "Exterior cupboards", "Floors"] },
    { title: "Bathroom Cleaning", description: "Fresh, hygienic bathroom care for shine, comfort and that just-cleaned feeling.", icon: "home", bestFor: "Bathrooms needing regular or deeper care", planningNote: "Tell us about showers, glass and priority areas.", pricingNote: "Add to any clean", recurringAvailable: true, included: ["Showers and screens", "Vanities", "Toilets", "Floors and mirrors"] },
    { title: "Move-In / Move-Out Cleaning", description: "A practical clean to help homes feel ready for a new chapter.", icon: "key", bestFor: "Fresh starts, move-ins and move-outs", planningNote: "Empty-home access and key areas are confirmed first.", pricingNote: "Custom enquiry", recurringAvailable: false, included: ["Kitchen and bathrooms", "Cupboards", "Floors", "Priority rooms"] },
    { title: "Custom Cleaning Requests", description: "Need specific rooms, tasks or a one-off reset? Send the details and we’ll shape the clean.", icon: "building", bestFor: "Homes with unique priorities", planningNote: "Send photos or a short list through Instagram if helpful.", pricingNote: "Message to discuss", recurringAvailable: true, included: ["Room priorities", "Task list", "Flexible scope", "Simple messaging"] },
  ],
