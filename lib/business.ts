...
export const business = validateBusinessConfig({
  ...
  mainHeadline: "Helping Homes Feel Spotless, Fresh & Glowing",
  ...
  hero: {
    ...
    title: "Helping Homes Feel Spotless, Fresh & Glowing",
    lead: "A warm local cleaning service for homes that deserve to feel calm, cared for and beautifully fresh again.",
    supportingText: "Send a quick message with what you need cleaned, your suburb and your preferred day. Everything is kept simple, friendly and easy to understand.",
    reassurance: "Soft personal care, friendly communication and a fresh-home feeling.",
  },
  about: {
    ...
    story: "Celestial Glow Cleaning Co. is built around care, detail, and the lovely relief of walking back into a fresh home. Whether you need a regular clean, a deep reset, or help getting your space back under control, the goal is simple: leave your home feeling spotless, calm and glowing.",
    ...
    ownerText: "This is a local cleaning service with a soft personal touch, clear communication, and the kind of careful detail that makes a home feel genuinely looked after.",
  },
  servicesPage: {
  ...
  whyChooseUs: {
    ...
    title: "Friendly local cleaning that feels personal.",
    description: "A warm Baldivis service for homes that need care, a fresh reset, or regular help keeping life calm.",
